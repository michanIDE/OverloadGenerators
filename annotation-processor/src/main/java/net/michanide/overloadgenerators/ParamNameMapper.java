...
public class ParamNameMapper extends AbstractProcessor {
    ...
    public Set<String> getSupportedOptions() {
        return Collections.singleton(OverGenAnnotationProcessors.MODULE_OPTION);
    }

    @Override
    public synchronized void init(ProcessingEnvironment processingEnv) {
        super.init(processingEnv);
        String mekModule = processingEnv.getOptions().getOrDefault(OverGenAnnotationProcessors.MODULE_OPTION, "mekanism");
        if (mekModule.equals("mekanism")) {
            // Scanners removed as per user request
        }
    }
