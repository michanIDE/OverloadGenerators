package net.michanide.overloadgenerators.builder;
...
import net.michanide.overloadgenerators.OverGenAnnotationProcessors;
import net.michanide.overloadgenerators.util.FakeParameter;
import net.michanide.overloadgenerators.visitors.AnnotationHelper;
import net.michanide.overloadgenerators.visitors.ParamToHelperMapper;
...
public class ComputerHandlerBuilder {
    ...
    private static final ClassName computerMethodFactoryRaw = ClassName.get(OverGenAnnotationProcessors.COMPUTER_INTEGRATION_PACKAGE, "ComputerMethodFactory");
    private static final ClassName baseComputerHelper = ClassName.get(OverGenAnnotationProcessors.COMPUTER_INTEGRATION_PACKAGE, "BaseComputerHelper");
    private static final ClassName computerException = ClassName.get(OverGenAnnotationProcessors.COMPUTER_INTEGRATION_PACKAGE, "ComputerException");
    private static final ClassName methodData = ClassName.get(OverGenAnnotationProcessors.COMPUTER_INTEGRATION_PACKAGE, "MethodData");
    ...
    public static void init(Elements elementUtils, Types typeUtils) {
        computerMethodAnnotationType = Objects.requireNonNull(elementUtils.getTypeElement(OverGenAnnotationProcessors.ANNOTATION_COMPUTER_METHOD)).asType();
        syntheticComputerMethodAnnotationType = Objects.requireNonNull(elementUtils.getTypeElement(OverGenAnnotationProcessors.ANNOTATION_SYNTHETIC_COMPUTER_METHOD)).asType();
        wrappingComputerMethodAnnotationType = Objects.requireNonNull(elementUtils.getTypeElement(OverGenAnnotationProcessors.ANNOTATION_WRAPPING_COMPUTER_METHOD)).asType();
        wrappingComputerMethodDocAnnotationType = Objects.requireNonNull(elementUtils.getTypeElement(OverGenAnnotationProcessors.ANNOTATION_WRAPPING_COMPUTER_METHOD_DOC)).asType();
        ...
        convertableType = Objects.requireNonNull(elementUtils.getTypeElement(OverGenAnnotationProcessors.COMPUTER_INTEGRATION_PACKAGE+".Convertable")).asType();
    ...
    public ComputerHandlerBuilder(TypeElement containingType, ProcessingEnvironment env) {
        ...
        this.handlerTypeSpec = TypeSpec.classBuilder(handlerClassName)
              ...
              .addAnnotation(
                    AnnotationSpec.builder(OverGenAnnotationProcessors.COMPUTER_METHOD_FACTORY_ANNOTATION)
