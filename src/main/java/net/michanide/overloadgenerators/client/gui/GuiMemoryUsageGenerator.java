...
import net.michanide.overloadgenerators.util.text.MemoryUsageDisplay;
import net.minecraft.client.gui.GuiGraphics;
import net.minecraft.network.chat.Component;
import net.minecraft.world.entity.player.Inventory;

public class GuiMemoryUsageGenerator extends GuiMekanismTile<BlockEntityMemoryUsageGenerator, MekanismTileContainer<BlockEntityMemoryUsageGenerator>> {

    public GuiMemoryUsageGenerator(MekanismTileContainer<BlockEntityMemoryUsageGenerator> container, Inventory inv, Component title) {
    ...
    protected void addGuiElements() {
        ...
        addRenderableWidget(new GuiInnerScreen(this, 43, 17, 90, 55, () -> {
            ...
            list.add(OverloadGeneratorsLang.MEMORY_USAGE.translate(MemoryUsageDisplay.of(tile.getMemoryUsage())));
