...
import net.michanide.overloadgenerators.util.text.CPUUsageDisplay;
import net.minecraft.client.gui.GuiGraphics;
import net.minecraft.network.chat.Component;
import net.minecraft.world.entity.player.Inventory;

public class GuiCPUUsageGenerator extends GuiMekanismTile<BlockEntityCPUUsageGenerator, MekanismTileContainer<BlockEntityCPUUsageGenerator>> {

    public GuiCPUUsageGenerator(MekanismTileContainer<BlockEntityCPUUsageGenerator> container, Inventory inv, Component title) {
