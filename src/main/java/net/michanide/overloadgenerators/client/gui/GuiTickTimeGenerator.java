...
public class GuiTickTimeGenerator extends GuiMekanismTile<BlockEntityTickTimeGenerator, MekanismTileContainer<BlockEntityTickTimeGenerator>> {

    public GuiTickTimeGenerator(MekanismTileContainer<BlockEntityTickTimeGenerator> container, Inventory inv, Component title) {
