...
public class OverGenBlocks {
    ...
    public static final BlockRegistryObject<BlockTileModel<BlockEntityServerCrashGenerator, Generator<BlockEntityServerCrashGenerator>>, ItemBlockMachine> SERVER_CRASH_GENERATOR = BLOCKS.register("server_crash_generator", () -> new BlockTileModel<>(OverGenBlockTypes.SERVER_CRASH_GENERATOR, properties -> properties.mapColor(MapColor.METAL)), ItemBlockMachine::new);
